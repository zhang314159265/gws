...
int main(int argc, char** argv) {
  ...
  mlir::triton::FuncOp funcop = builder.createFuncOp("sum_fn", {f32pty, f32pty, i32ty, i32ty}, {}, true);
  {
    ...
    funcop.setArgAttr(1, "tt.divisibility", mlir::IntegerAttr::get(attrTy, 16));
    funcop.setArgAttr(2, "tt.divisibility", mlir::IntegerAttr::get(attrTy, 16));
    funcop.setArgAttr(3, "tt.divisibility", mlir::IntegerAttr::get(attrTy, 16));
  }
